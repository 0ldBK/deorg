...
content = '<div style="position: fixed; top: 20px; left: 20px; width: 600px; background-color: white; margin: 10px 10px 10px 10px; z-index: 100; opacity: 0.8; -webkit-animation: fadeOut 1000ms;"><h1><img src="https://www.timezero.ru/i/smile/crazynuts.gif"> Сотрудничество с админами Завершено! Теперь плагин работает НЕ ОФИЦИАЛЬНО</h1>'+
			'<h2><p><b style="color: red">ВНИМАНИЕ:</b> Плагин пытаются блокировать <b style="color: red">админы олдбк</b>.</p>'+
			'<p><a href="https://pp.vk.me/c620124/v620124283/13348/1E0SYeXrtis.jpg" target="_blank">Денис Фёдоров - Дэйвин (кликабельно)</a> лгун и пешка Архитектора. Контакты Дэйвин - скайп dawincheg, Архитектор - скайп suspicious_face</p></h2>'+
